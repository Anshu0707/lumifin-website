      ...
      <main className="pt-40 pb-32 px-6 md:px-8">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
            ...
            >
              <ArrowLeft className="w-4 h-4" /> {t('travelMoney.common.viewAllDestinations')}
            </Link>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="mb-20">
            ...
            <div className="mt-12 text-center">
              <Link
                to="/#destinations"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl border-2 border-slate-200 text-slate-700 font-black text-sm uppercase tracking-widest hover:border-primary hover:text-primary transition-all"
              >
                {t('travelMoney.common.viewAllDestinations')} <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </motion.div>
