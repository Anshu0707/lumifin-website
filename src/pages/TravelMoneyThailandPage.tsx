...
const STAT_KEYS = ['currency', 'atmFee', 'cardAcceptance', 'qrAdoption'] as const;
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b-2 border-slate-200">
                      <th className="text-left py-4 pr-4 text-sm font-black text-slate-900 uppercase tracking-widest">{t(`${ns}.tableHeaders.method`)}</th>
                      <th className="text-left py-4 pr-4 text-sm font-black text-slate-900 uppercase tracking-widest">{t(`${ns}.tableHeaders.fee`)}</th>
                      <th className="text-left py-4 pr-4 text-sm font-black text-slate-900 uppercase tracking-widest">{t(`${ns}.tableHeaders.rate`)}</th>
                      <th className="text-left py-4 pr-4 text-sm font-black text-slate-900 uppercase tracking-widest">{t(`${ns}.tableHeaders.speed`)}</th>
                    </tr>
                  </thead>
