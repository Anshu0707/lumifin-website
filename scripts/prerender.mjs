...
const routes = [
  ...
  { path: '/blog/founder-note-testing-lumifin-in-hanoi', out: 'blog/founder-note-testing-lumifin-in-hanoi.html' },
  { path: '/blog/why-we-chose-da-nang', out: 'blog/why-we-chose-da-nang.html' },
